                ...
                <div class="col-xl-3 col-lg-4">
                    <div class="card faq-left">
                        <div class="social-profile">
                            <img class="img-fluid" src="<?php echo base_url(); ?>assets/back/images/social/profile.jpg" alt="">
                        ...
                        <div class="card-block">
                            ...
                            <ul>
                                ...
                                <li class="faq-contact-card">
                                    ...
                                    <a href="http://phoenixcoded.com/" target="_blank">www.phoenixcoded.com</a>
                                </li>
                                <li class="faq-contact-card">
                                        ...
                                        <div class="project-table">
                                            <div class="table-responsive">
                                                <table class="table">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <img src="<?php echo base_url(); ?>assets/back/images/avatar-2.png" class="img-circle" alt="tbl">
                                                        </td>
