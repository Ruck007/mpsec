...
<!-- Mirrored from ableproadmin.com/light/vertical/404.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Mar 2017 07:58:36 GMT -->
<head>
    <title>MPA Application: Error 404</title>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="text-uppercase col-xs-12">
                ...
                <a href="<?php echo base_url(); ?>" class="btn btn-error btn-lg waves-effect">back to home page</a>
            </div>
        </div>
        <!-- Row end -->
    </div>
