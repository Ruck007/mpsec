...
<head>
    ...
    <title><?php echo $imagebrowser1; ?> :: Ruckjung.com <?php echo getcwd()?></title>
...
<div id="header">
    <a class="" href="http://ruckjung.com/" target="_blank"><img src="img/favicon.png" class="headerIconLogo"></a>
