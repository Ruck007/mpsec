...
//$rootappfolder = ""; //hosting
$rootappfolder = substr(pathinfo("$_SERVER[REQUEST_URI]", PATHINFO_DIRNAME), 0, 14); //local

//$useruploadfolder = "$rootappfolder/uploads/contents"; // / root / appfolder / uploads
$useruploadfolder = "$browserfolder/uploads"; // / root / appfolder / ckeditor folder / / / / uploads
$useruploadpath = $usersiteroot."$useruploadfolder/";
