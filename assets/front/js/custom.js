$(document).ready(function () {
    'use strict'; if ($(".featured-slider").length) { $(".featured-slider").owlCarousel({ autoPlay: 5000, items: 2, pagination: false, itemsMobile: [768, 1], itemsDesktop: [1199, 2], itemsDesktopSmall: [979, 1] }); }
    if ($(".full-news-slider").length) { $(".full-news-slider").owlCarousel({ navigation: true, slideSpeed: 800, paginationSpeed: 600, pagination: false, singleItem: true }); }
    ...
    if ($("#cp-list-news-slider").length) { $("#cp-list-news-slider").owlCarousel({ navigation: true, slideSpeed: 800, paginationSpeed: 600, singleItem: true, pagination: false, }); }
